...
import { Button, Text } from '@olympfinance/uikit'
            ...
            <>
              ...
              <Text color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive LMPTEST rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to LMPTEST.'}
              </Text>
            </>
          )}
          <RowBetween>
